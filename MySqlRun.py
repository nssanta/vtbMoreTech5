...
class MySqlRun:
    def __init__(self,city='Уссурийск', host='localhost', user='root', password='root', database='vtbsc', scripts=[
        ...
        self.YANDEX_MAPS_API_KEY = '578ef2e1-9204-4f6d-a51e-bb8fc7cb9397'
        self.YANDEX_MAPS_API_KEY_GEOCODER = '7a8a7af5-e2ee-4286-8ad5-a1cf4558f9bd'
    ...
    def find_vtb_branches(self,city=None):
        ...
        if city_coordinates:
            ...
            url = f'https://search-maps.yandex.ru/v1/?apikey={self.YANDEX_MAPS_API_KEY}&text={bank_encoded}&type=biz&results=500&lang=ru_RU&ll={latitude},{longitude}&spn=0.1,0.1'
